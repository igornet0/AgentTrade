...
from apps.data_parser.parsers import *
...
class Handler:
    ...
    _parsers = {
        "parser kucoin web": ParserKucoin,
        "parser news": ParserNews,
        "parser api": ParserApi
    }

    # def __init__(self, URL: str, parser: ParserKucoin | ParserNews, login: str = None, password: str = None) -> None:
    #     self.URL = URL

    #     self.parser: ParserApi = parser
    #     self.login = login
    #     self.password = password
    #     self.flag_start_parser = False
