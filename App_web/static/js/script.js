...
function StartTrade() {
    if (document.getElementById('tradeWidget').style.display === 'block') {
        document.getElementById('tradeWidget').style.display = 'none'; // Скрываем виджет
    } else {
...
function StartTrain() {
    if (document.getElementById('trainWidget').style.display === 'block') {
        document.getElementById('trainWidget').style.display = 'none'; // Скрываем виджет
    } else {
...
function StartParser() {
    if (document.getElementById('parserWidget').style.display === 'block') {
        document.getElementById('parserWidget').style.display = 'none'; // Скрываем виджет
    } else {
        document.getElementById('parserWidget').style.display = 'block'; // Показываем виджет
    }
}
